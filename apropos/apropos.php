...
.bg-light {
    background-color: #798477 !important;
}
</style>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 co-sm-l2">
                    <div class="about_box">
                        <h2>LA FOURCHETTE<br><strong class="black"> LE RESTAURANT DU CHOIX </strong></h2>
                        <p>dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi
                            ut aliquip ex dolor sit amet, consectetur adipiscing
    ...
    <div class="offer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title">
                        <h2>Nos <strong class="black"> Specialite</strong></h2>
                    </div>
                </div>
            </div>
        </div>
